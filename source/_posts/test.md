...
请配合 [源代码](https://github.com/NanodaOvO/nanodaovo.github.io/blob/main/source/_posts/test.md) 阅读本文

<h1 align="center">⚠⚠⚠WARNING!!!!你需要通过下载VScode或Typora来获取阅读本文的权限！⚠⚠⚠</h1>
...
我们只介绍一个`\`吧,`\`要紧挨着正文，不可以加空格，不然可能会出现一些问题。
...
![Koishi](/resource/photo/109561822_p1_master1200.jpg "恋恋可爱")
